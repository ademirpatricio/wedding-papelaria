  ...
  return (
    <section className="bg-[#f7f3ef] px-4 py-24 md:px-8">
      <div className="mx-auto grid max-w-7xl items-center gap-16 md:grid-cols-2">
        ...
        >
          {/* glow */}
          <div className="absolute bottom-10 h-[420px] w-[420px] rounded-full bg-[#f3d9ff]/40 blur-3xl" />

          {/* image */}
          <div className="relative overflow-hidden rounded-[36px]">
            <img
              src="/images/checklist/thayna.png"
              alt="Thayná Aguiar"
        ...
        <div data-aos="fade-left" data-aos-delay="150">
          ...
          <h2 className="font-['Source_Serif_4'] text-5xl leading-tight text-[#2d0b45] md:text-6xl">
            Criado por quem vive o universo dos casamentos todos os dias
          </h2>

          <div className="mt-8 space-y-6 text-xl leading-relaxed text-[#5f5466]">
            <p>
          ...
          <div className="mt-10">
            ...
            <h3 className="mt-2 font-['Source_Serif_4'] text-3xl text-[#2d0b45]">
              Thayná Aguiar
            </h3>
          </div>
        </div>
